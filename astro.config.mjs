      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Public API (v1)', slug: 'configuration/api' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Library Import', slug: 'guides/library-import' },
            { label: 'Multiple Editions', slug: 'guides/editions' },
            { label: 'Ebooks', slug: 'guides/ebooks' },
        ...
        {
          label: 'narratorr-requests',
          items: [
            { label: 'Overview', slug: 'narratorr-requests' },
            { label: 'Installation', slug: 'narratorr-requests/installation' },
            { label: 'Authentication & Access', slug: 'narratorr-requests/authentication' },
            { label: 'Configuration', slug: 'narratorr-requests/configuration' },
            { label: 'Using narratorr-requests', slug: 'narratorr-requests/using' },
            { label: 'Troubleshooting', slug: 'narratorr-requests/troubleshooting' },
          ],
        },
