      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Configuration', slug: 'narratorr-request/configuration' },
            { label: 'Using narratorr-request', slug: 'narratorr-request/using' },
            { label: 'Troubleshooting', slug: 'narratorr-request/troubleshooting' },
          ],
        },
