...
- **Merge & Convert** (Settings > Audio Tools) — the output format, bitrate, and merge behavior used whenever files are merged or converted
- **Auto-merge multi-file downloads** (Settings > Post Processing) — automatically merge a completed download's files after import
