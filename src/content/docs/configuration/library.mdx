...
- **Delete After Import** (Settings > General > Import section) — remove files from the download client after import
- **Minimum Seed Time** (Settings > General > Import section) — for torrents, wait until the minimum seed time before importing
