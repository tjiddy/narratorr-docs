...
| Field | Description |
|-------|-------------|
| **MAM ID** | A dedicated MAM session ID. Generate one under **MAM > Preferences > Security > Create Session** — don't paste the `mam_id` cookie from your logged-in browser; Narratorr expects its own session. |
