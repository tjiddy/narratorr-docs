...
| Field | Default | Description |
|-------|---------|-------------|
| **Watch Folder** | — | Directory where Narratorr drops `.torrent` or `.nzb` files |

Narratorr places the release file in the watch folder and immediately marks the download as "completed." It does **not** monitor progress — your external client handles the actual download. Narratorr will attempt to import from the watch folder on the next import cycle.
