...
| Setting | Description |
|---------|-------------|
| **Enable ebook support** | Show ebooks already stored in a book's folder, ready to download from the book page. Narratorr doesn't search for or download ebooks. Enabling this also exposes them over the API, which is how [Narratorr Requests](/narratorr-requests/) offers Download and Send to Kindle. Default: off. |
