...
Audio processing (merge/convert) is a separate operation, manual by default — the opt-in **Merge multi-file downloads** toggle automates the merge for completed downloads. Either way, tagging does not depend on it.
