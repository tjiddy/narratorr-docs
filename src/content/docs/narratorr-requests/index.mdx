...
requires an **Email (SMTP)** notifier to be configured; without one the opt-ins are shown
disabled. Requesters can always follow status live on their **My Requests** page either way.
:::
...
itself. See [Using → eBooks](/narratorr-requests/using/#ebooks-download-or-send-to-kindle).
