...
**Check:**
- **ffmpeg not found** — verify the path in Settings > Post Processing. In Docker, ffmpeg is pre-installed at the default path.
...
- **Event is subscribed** — the notifier must be subscribed to the specific event (grab, download complete, import, failure, health issue)
